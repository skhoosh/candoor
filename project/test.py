...
def getMessages(personid, otherpersonid):
    results = conn.runInstalledQuery("show_messages", params={
                                     "personid_para": personid, "otherpersonid_para": otherpersonid})

    messageList = []
    for message in results[0]["result"]:
        messageList.append({"sender": message["attributes"]["@sender"][0],
                           "text": message["attributes"]["text"], "time": message["attributes"]["time"]})
...
def displayChatList(personid):
    results = conn.runInstalledQuery("get_chat_list", params={
                                     "personid_vertex": personid})
...
c = [{'name': 'Stephanie Bot', 'id': 2}, {
    'name': 'Stephanie Bot', 'id': 3}, {'name': 'Stephanie Bot', 'id': 6}]
...
# mentees = find_mentees(1, "machine learning",
                    #    "I've done validation engineering for 5 years. Feel free to ask.", 4)
...
# test_mentors=   find_mentors(1, "machine learning", "I'm interested to learn machine learning.", 3)
# print(test_mentors)
...
mentees_results = [
    ...
    'profile_picture': 'audrey.jpg', 
    'profile_header': 'Candoor cofounder', 
    'pronouns': '', 
    'profile_description': 'Validation engineer by day, tigergrapher at night.', 
    'open_to_connect': True, 
    '@speciality': 'Machine Learning', 
    '@has_aspiration': {'num': 1, 'description': "I'm interested to learn machine learning.", 'interest_level': 3, 'looking_for_mentor': True},
     '@score': 5}
     ]
